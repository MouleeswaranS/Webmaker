...
const AboutSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo(
        ...
        { x: "-100vw", opacity: 0 },
        {
          ...
          scrollTrigger: {
            ...
            start: "top 80%",
            invalidateOnRefresh: true, // ✅ Fix for refresh issues
          },
        }
      );
      ...
      ScrollTrigger.refresh(); // ✅ Force recalculation after page load
  ...
  return (
    <section
      id="AboutUs" // ✅ Fix: Removed "#" for ID to avoid hash issues
      ref={sectionRef}
    ...
    >
      ...
      <div className="w-full grid md:grid-cols-2 items-center gap-12 md:gap-16 relative z-10">
        <div className="flex justify-center" ref={imageRef}>
          <div className="rounded-3xl overflow-hidden shadow-2xl group relative z-20">
            <img
              src={aboutImage}
              alt="About Us"
